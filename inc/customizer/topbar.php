...
$wp_customize->add_panel( 'header_top_panel', array(
    'title'          => __( 'Header Top', 'creativ-musician' ),
    'priority'       => 20,
...
$wp_customize->add_section(
    ...
    array(
        'title'    => __( 'Contact Info', 'creativ-musician' ),
...
$wp_customize->add_control(
    'theme_options[show_header_contact_info]',
    array(
        'label'       => __( 'Show Contact Info', 'creativ-musician' ),
...
$wp_customize->add_control(
    ...
    array(
        'label'           => __( 'Location', 'creativ-musician' ),
        'description'     => __( 'Enter Location.', 'creativ-musician' ),
        'section'         => 'header_contact_info_section',
        'active_callback' => 'creativ_musician_contact_info_ac',
    )
);
...
$wp_customize->add_control(
    ...
    array(
        'label'           => __( 'Phone', 'creativ-musician' ),
        'description'     => __( 'Enter phone number.', 'creativ-musician' ),
        'section'         => 'header_contact_info_section',
        'active_callback' => 'creativ_musician_contact_info_ac',
    )
);
...
$wp_customize->add_control(
    'theme_options[header_email]',
    array(
        'label'           => __( 'Email', 'creativ-musician' ),
        'description'     => __( 'Enter valid email address.', 'creativ-musician' ),
        'section'         => 'header_contact_info_section',
        'active_callback' => 'creativ_musician_contact_info_ac',
    )
);
...
$wp_customize->add_section(
    ...
    array(
        'title'    => __( 'Social Links', 'creativ-musician' ),
        'panel'    => 'header_top_panel',
        'priority' => 20,
    )
);
...
$wp_customize->add_control(
    'theme_options[show_header_social_links]',
    array(
        'label'       => __( 'Show Social Links', 'creativ-musician' ),
...
$wp_customize->add_control(
    'theme_options[social_link_1]',
    array(
        'label'           => __( 'Social Link 1', 'creativ-musician' ),
        'description'     => __( 'Enter valid url.', 'creativ-musician' ),
        'section'         => 'header_social_links_section',
        'type'            => 'url',
        'active_callback' => 'creativ_musician_social_links_active',
    )
);
...
$wp_customize->add_control(
    'theme_options[social_link_2]',
    array(
        'label'           => __( 'Social Link 2', 'creativ-musician' ),
        'description'     => __( 'Enter valid url.', 'creativ-musician' ),
        'section'         => 'header_social_links_section',
        'type'            => 'url',
        'active_callback' => 'creativ_musician_social_links_active',
...
$wp_customize->add_control(
    'theme_options[social_link_3]',
    array(
        'label'           => __( 'Social Link 3', 'creativ-musician' ),
        'description'     => __( 'Enter valid url.', 'creativ-musician' ),
        'section'         => 'header_social_links_section',
        'type'            => 'url',
        'active_callback' => 'creativ_musician_social_links_active',
